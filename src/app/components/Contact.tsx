...
const formSchema = z.object({
  ...
  message: z.string().min(10, "A mesndagem deve ter ao menos 5 caracteres"),
})
...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="py-20 bg-gradient-to-br from-blue-100  to-emerald-150 dark:from-gray-900 dark:to-emerald-900 transition-colors duration-300 overflow-hidden relative"
    >
          ...
          >
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
              ...
              <div className="space-y-6">
                <a
                  href="mailto:uilhermegomes.ccti@gmail.com"
